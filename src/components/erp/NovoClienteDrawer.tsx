...
/**
 * Drawer reutilizável de cadastro rápido de cliente (PJ/PF) com autopreenchimento por CNPJ
 * (Receita) e CEP. Usado pelo atendimento, edição de pedido e onde mais precisar acelerar a
 * inclusão de um cliente novo sem sair do fluxo da venda.
 */
export function NovoClienteDrawer({ onClose, onCreated }: { onClose: () => void; onCreated: (c: ClienteCriado) => void }) {
