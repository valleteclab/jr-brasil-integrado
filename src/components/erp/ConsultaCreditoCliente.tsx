      ...
      {n && (
        <div style={{ marginTop: 12, display: "grid", gap: 10 }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", fontSize: 13 }}>
            ...
            {ultima && (
              <a href={`/api/erp/creditos/consultas/${ultima.id}/laudo`} target="_blank" rel="noreferrer" className="btn-erp ghost xs">
                📄 Laudo (PDF)
              </a>
            )}
            {n.pdfUrl && <a href={n.pdfUrl} target="_blank" rel="noreferrer" className="btn-erp ghost xs">📄 Laudo do bureau (PDF)</a>}
          </div>
