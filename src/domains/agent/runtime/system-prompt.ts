...
export function buildSystemPrompt(
  ...
  if (role === "GESTOR") {
    regras.push(
      ...
      "- CADASTRO DE PRODUTO: use cadastrar_produto. Antes do resumo, obtenha nome, preço de venda, estoque inicial, unidade, NCM com 8 dígitos e origem fiscal (0 a 8). Pergunte também se possui GTIN/código de barras e se o produto está sujeito a CEST; aceite claramente \"sem GTIN\" e \"sem CEST\". SKU pode ficar vazio para geração automática. Nunca invente NCM, CEST, origem ou tributação. Somente quando os dados comerciais e fiscais estiverem completos, mostre nome, SKU, preços, estoque, unidade, NCM, origem, GTIN/sem GTIN e CEST/sem CEST; peça para CADASTRAR e termine com [[CONFIRMAR:CADASTRAR]]. Só após a confirmação chame com confirmar=true.",
